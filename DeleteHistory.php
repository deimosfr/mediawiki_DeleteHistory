...
$wgExtensionCredits['specialpage'][] = array(
	...
	'description' => "Add a special page to delete old history (revision) of articles",    	// Description of what the extension does - string
	'descriptionmsg' => "delhist-msg",														// Same as above but name of a message, for i18n - string, added in 1.12.0
